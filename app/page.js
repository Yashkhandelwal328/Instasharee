    ...
    <div className="app-container">
      ...
      <div id="auth-overlay" className="auth-overlay">
        <div className="auth-card animate-scale-in">
          ...
          <h2 className="auth-title">Welcome to instashare</h2>
          <p className="auth-sub">Sign in to start transferring files securely across any network.</p>
          
          <div className="auth-actions">
            <button id="btn-auth-google" className="btn-auth-google">
              ...
              <div className="auth-btn-spinner spinner hidden"></div>
            </button>
            <div className="auth-divider"><span>or</span></div>
            <button id="btn-auth-guest" className="btn-auth-guest">Continue as Guest</button>
          </div>
        </div>
      </div>
      ...
      <div className="app-content">
        ...
        <header className="header">
          ...
          <div id="user-profile" className="user-profile hidden">
            <div id="user-avatar" className="user-avatar">?</div>
            <span id="user-name" className="user-name">Guest</span>
            <button id="btn-sign-out" className="btn-sign-out">Sign out</button>
          </div>
          <button id="btn-header-sign-in" className="btn-sign-in">Sign in</button>
        </header>
